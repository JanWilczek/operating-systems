 ...
 * @return a pointer to allocated ipc_queue_t structure.
 * */
extern ipc_queue_t* get_queue(const char* name);

/**
 * Closes the given queue-does not free the passes structure.
 * */ 
extern void close_queue(ipc_queue_t* queue_to_close);
